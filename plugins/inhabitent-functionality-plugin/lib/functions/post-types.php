...
function adventures_post_type()
{
    ...
    $labels = array(
        'name'                  => _x('Adventure Posts', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Adventure Post', 'Post Type Singular Name', 'text_domain'),
    ...
    $args = array(
        'label'                 => __('Adventure Post', 'text_domain'),
        'description'           => __('This is where the adventure begins.', 'text_domain'),
        'labels'                => $labels,
